        ...
        <Card>
          <CardContent>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1, mb: 2 }}>
              <Chip label={`Liability: ${result.liability_limit}`} variant="outlined" color="primary" />
              <Chip label={`Medical: ${result.medical_limit}`} variant="outlined" color="primary" />
              <Chip label={`Property: ${result.property_limit}`} variant="outlined" color="primary" />
              <Chip label={`Uninsured Motorist: ${result.uninsured_motorist_limit}`} variant="outlined" color="primary" />
              <Chip label={`Deductible: ${result.deductible}`} variant="outlined" color="secondary" />
            </Box>
